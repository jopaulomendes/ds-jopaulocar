    ...
    ***************************************************************************** */
    ...
    var CurrencyInput = React.forwardRef(function (_a, ref) {
        ...
        var processChange = function (value, selectionStart) {
            ...
            var formattedValue = formatValue(__assign({ value: valueOnly }, formatValueOptions));
        ...
        var handleOnKeyDown = function (event) {
            ...
            if (step && (key === 'ArrowUp' || key === 'ArrowDown')) {
                ...
                var fixedLength = String(step).includes(decimalSeparator)
        ...
        var inputProps = __assign({ type: 'text', inputMode: 'decimal', id: id,
            ...
            disabled: disabled, value: formattedPropsValue !== undefined && stateValue !== '-' && stateValue !== decimalSeparator
                ? formattedPropsValue
                : stateValue, ref: inputRef }, props);
        if (customInput) {
